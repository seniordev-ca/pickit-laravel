...
{{--                            <span class="text-white-75">Dash</span><span class="text-white">mix</span>--}}
                ...
                <div class="bg-header-light">
                    <div class="content-header bg-white-10 header-div-avatar" >
                        <a class="block block-rounded text-center bg-image header-a-avatar" style="background-image: url({{asset('media/photos/Food1.jpg')}});" href="javascript:void(0)">
                            <div class="block-content bg-white-90">
                                <img class="img-avatar img-avatar-thumb" src="{{asset('media/avatars/admin_avatar.png')}}" alt="">
                            </div>
                            <div class="block-content block-content-full bg-white-90">
                                <p class="font-w600 mb-0">Admin</p>
                ...
                <div class="content-side content-side-full">
                    <ul class="nav-main">
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('customers*') ? ' active' : '' }}" href="{{url('/customers')}}">
...
{{--                        </li>--}}
                        ...
                        <li class="nav-main-item">
                            <a class="nav-main-link{{ request()->is('product*') ? ' active' : '' }}" href="{{url('/products')}}">
                ...
                <div class="content py-0">
                    <div class="row font-size-sm">
                        <div class="col-sm-6 order-sm-2 mb-1 mb-sm-0 text-center text-sm-right">
                            Crafted with <i class="fa fa-heart text-danger"></i> by <a class="font-w600" href="https://www.freelancer.com/u/leemilun?w=f" target="_blank">Gao</a>
                        </div>
                        <div class="col-sm-6 order-sm-1 text-center text-sm-left">
                            <a class="font-w600" href="{{url('/')}}" target="_blank">OMNI</a> &copy; <span data-toggle="year-copy">2019</span>
                        </div>
                    </div>
                </div>
            </footer>
